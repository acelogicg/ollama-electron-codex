export const chatModes = [
  {
    ...
    instruction: [
      ...
      'You have real tools: read_file, write_file, edit_file, list_directory, search_text, inspect_project, and run_command. All paths are relative to the workspace root.',
      ...
      'MANDATORY BEFORE THE FIRST run_command: call inspect_project, inspect the detected manifests, dependency manager, scripts, working directory, and virtual environment, then choose a command that actually exists for that project. Never install or update dependencies unless the user explicitly requests it.',
